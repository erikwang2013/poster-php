...
│   ├── Storage/                # যাচাই ডেটার স্টোরেজ: File / Session / Redis
...
| এলোমেলোতা | প্রতিবার তৈরি হওয়া ব্যাকগ্রাউন্ডের রং, নয়েজ ও লক্ষ্যের অবস্থান এলোমেলো |
