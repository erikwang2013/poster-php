...
│   ├── Storage/                # कैप्चा डेटा स्टोरेज: File / Session / Redis
...
| रैंडमनेस | हर बार बनने वाला बैकग्राउंड रंग, नॉइज़ और लक्ष्य स्थिति बेतरतीब होती है |
