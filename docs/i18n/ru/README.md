...
│   ├── Storage/                # Хранилище данных проверки: File / Session / Redis
...
├── tests/                      # Тесты PHPUnit, 41 файл, структура повторяет src/
...
| Случайность | Цвет фона, шум и положение целей при каждой генерации случайны |
